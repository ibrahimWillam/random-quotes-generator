...
var auther =["― Oscar Wilde","― Marilyn Monroe","― Albert Einstein","― Frank Zappa","― Marcus Tullius Cicero","― Bernard M. Baruch"];
var num= Math.floor(Math.random()*text.length);
document.getElementById('text').innerHTML= text[num];
document.getElementById('auther').innerHTML= auther[num];
};